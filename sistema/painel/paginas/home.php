    ...
    <div class="row-one widgettable">
        ...
        <div class="col-md-12 content-top-2 card">
            ...
            <div class="agileinfo-cdr">
                ...
                <div id="Linegraph" style="width: 100%; height: 450px">
                </div>
                <div class="legend">
                    <div class="legend-item">
                        <div class="legend-color" style="background-color: #e32424;"></div>
                        <div class="legend-text">Despesas</div>
                    </div>
                    <div class="legend-item">
                        <div class="legend-color" style="background-color: #109447;"></div>
                        <div class="legend-text">Vendas</div>
                    </div>
                    <div class="legend-item">
                        <div class="legend-color" style="background-color: #0e248a;"></div>
                        <div class="legend-text">Serviços</div>
                    </div>
                </div>
            </div>
