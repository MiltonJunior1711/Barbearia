...
// Capturando os dados do formulário quando o método for POST
            ...
            <form id="form-agenda" method="post" style="margin-top: -25px !important">
                <div class="footer_form footer-col">
                    <div class="form-group">
                        <input onchange="buscarNome()" class="form-control" type="text" name="telefone" id="telefone"
                            placeholder="Seu Telefone DDD + número" required />
                    </div>
                    ...
                    <a class="botao-azul" id='botao_editar' onclick="verificarAgendamento();"
...
function verificarAgendamento() {
    ...
    if (!validarTelefone(telefone)) {
        window.alert('Verifique ou Adicione seu número de Telefone!');
        shakeForm();
        ...
        success: function(mensagem) {
            ...
            if (mensagem.trim() == "Agendado com Sucesso") {
                ...
                if (msg_agendamento == 'Sim') {
                    ...
                    a.target = '_blank';
                    a.href =
                        'http://api.whatsapp.com/send?1=pt_BR&phone=<?=$tel_whatsapp?>&text= _Novo Agendamento_ %0A Funcionário: *' +
                        nome_func + '* %0A Serviço: *' + nome_serv + '* %0A Data: *' +
                        dataFormatada + '* %0A Hora: *' + horaFormatada + '* %0A Cliente: *' +
                        nome + '*  %0A %0A ' + obs;
                    a.click();
                    return;
